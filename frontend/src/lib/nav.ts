...
export const NAV: NavItem[] = [
  ...
  { label: "Österreich-Compliance", href: "/tax/austria",  icon: ShieldCheck,      section: "Reports", forModule: "at_compliance" },
  { label: "UGB-Abschluss",    href: "/tax/austria/ugb",  icon: Landmark,         section: "Reports", forModule: "at_compliance" },
  { label: "E/A-Rechnung",     href: "/tax/austria/ear",  icon: BookOpen,         section: "Reports", forModule: "at_compliance" },
