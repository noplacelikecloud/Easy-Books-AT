...
const NAV_ALIASES: Record<string, string[]> = {
  ...
  "/inventory/pick-lists":   ["pick pack", "pick list", "reservation", "wms packing"],
  ...
  "/expense-claims":         ["expense claim", "reimbursement", "employee expense"],
  ...
  "/settings/catalog":       ["catalog", "workflow catalog", "tags", "snapshots", "screenshots", "help gallery"],
  ...
  "/weighbridge":            ["weighbridge", "scale", "truck weigh", "mill scale", "gate pass", "tare", "gross", "net kg"],
  "/weighbridge/tickets":    ["weighbridge tickets", "weighbridge register", "vehicle in out", "wb ticket"],
  "/weighbridge/tickets/new":["new weighbridge ticket", "first weigh", "second weigh"],
  "/weighbridge/reports/register": ["weighbridge register", "ticket register", "vehicle register"],
...
const ACTIONS: NavResult[] = [
  ...
  },
  {
    ...
    sub: "Record inbound or outbound vehicle weigh", href: "/weighbridge/tickets/new",
    keywords: ["new weighbridge", "weigh in", "weigh out", "new ticket"],
  },
  {
    id: "qa:weighbridge-register", type: "action", label: "Weighbridge Register",
    sub: "Ticket register with date filter", href: "/weighbridge/reports/register",
    keywords: ["weighbridge register", "ticket register", "vehicle register"],
  },
  {
...
const REPORTS: NavResult[] = [
  ...
  {
    id: "sys:catalog", type: "nav", label: "Workflow Catalog",
    sub: "Snapshots and tags for every tenant, workflow, and report", href: "/settings/catalog",
    keywords: ["catalog", "workflow catalog", "tags", "snapshots", "screenshots", "gallery", "help pictures"],
  },
  {
