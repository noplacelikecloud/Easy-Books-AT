    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[var(--text-primary)]/60 text-sm mt-1">{total} assets · IAS 16</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-[var(--text-primary)]/5 overflow-hidden">
        ...
        <table className="w-full text-sm min-w-[560px]">
          ...
          <tbody>
            {isLoading ? (
              <tr><td colSpan={7} className="ui-td text-center text-[var(--text-primary)]/40 italic">{t('common.loading', 'Loading...')}</td></tr>
            ) : items.length === 0 ? (
              <tr>
              ...
              <tr key={a.id} className={`border-t border-[var(--text-primary)]/5 hover:bg-[var(--bg-page)]/50${a.is_disposed ? ' opacity-50' : ''}`}>
                ...
                <td className="ui-td text-[var(--text-primary)]/60">{a.acquisition_date}</td>
