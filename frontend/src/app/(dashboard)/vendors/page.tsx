        ...
        <table className="w-full text-sm min-w-[560px]">
          ...
          <tbody className="divide-y divide-[var(--border)]">
            {isLoading ? (
              ...
              <tr key={v.id} className={`hover:bg-[var(--bg-page)]/50 ${selectedIds.has(v.id) ? 'bg-[var(--primary-light)]' : ''}`}>
          ...
          {isLoading ? (
            ...
            >
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-[var(--text-primary)] truncate">{v.name}</p>
