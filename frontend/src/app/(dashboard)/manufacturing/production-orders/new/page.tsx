...
export default function NewProductionOrderPage() {
  ...
  return (
    <div className="max-w-xl space-y-6">
      <div>
        <Link href="/manufacturing/production-orders" className="text-sm text-[#b8943f] hover:underline">
          ← Production Orders
        </Link>
        <h1 className="text-2xl font-serif font-semibold text-[#1a1814] mt-2">New Production Order</h1>
        <p className="text-sm text-[#1a1814]/60 mt-0.5">Start a batch from a Bill of Material.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-[#ede9e2] rounded-xl p-5 space-y-4">
        <div>
        ...
        <div>
          <label className="block text-xs font-semibold text-[#1a1814]/70 mb-1.5 uppercase tracking-wide">
            Rate Plan <span className="font-normal normal-case text-[#1a1814]/50">(optional — auto-picks customer&apos;s active plan)</span>
          </label>
