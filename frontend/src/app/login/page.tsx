...
const DEMO_OPTIONS: DemoOption[] = [
  ...
  { label: "PRA e-Invoice",     email: "demo.pra@easy-books.app",    model: "pra_einvoice",     blurb: "Pakistani retail — PRA e-Invoice, PKR, sandbox mode. Toggle portal/full view from the sidebar." },
]
