              ...
              const allocPreview = allocations
                ...
                .map(a => {
                  ...
                  return {
                    ...
                    carryingRate: Number(inv?.carrying_rate ?? inv?.exchange_rate ?? 1),
                  }
                })
                ...
                <>
                  {preview && (
                    <div className="col-span-2 grid grid-cols-3 gap-2 text-xs font-mono">
                      ...
                      <div>
                        <p className="text-[10px] uppercase tracking-widest text-amber-800/70 mb-0.5">AR cleared</p>
                      ...
                      <div>
                        ...
                        <p className={`font-semibold ${Math.abs(preview.realised) < 0.005 ? '' : preview.realised > 0 ? 'text-green-700' : 'text-red-700'}`}>
                          {fxGainLossLabel(preview.realised, 'receipt')}
                        </p>
                      </div>
                    </div>
                  )}
