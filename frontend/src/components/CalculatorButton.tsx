  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-36 right-4 md:bottom-24 md:right-20 z-[850] w-12 h-12 rounded-full shadow-lg flex items-center justify-center transition-all duration-200
          ${open
