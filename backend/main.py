...
from routers import (
    ...
    reconciliations, recurring, report_builder, reports, settings, scrap_reasons, stock_locations, stock_transfers, store_issues, store_reports,
    subledger, tax_codes, telecom, telecom_reports, transactions, users, vendors,
    permissions, commissions, promo_rules, payroll, attendance, leave, system_update,
...
_ROUTERS = [
    ...
    bank_imports.router, stock_locations.router, stock_transfers.router,
